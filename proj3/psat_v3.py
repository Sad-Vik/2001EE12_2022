...
st.title('DAT to CSV Converter')
st.text('For convertion first input some variables.')

var_1 = st.text_input("constant_fk2d")
var_2 = st.text_input("multiplying_factor_3d")
var_3 = st.text_input("Shear_velocity")

if var_1 and var_2 and var_3:
    st.subheader('Select one option')
    st.write(['1. C', '2. S', '3. A', '4. C & S', '5. C & A', '6. S & A', '7. C & S & A', '8. all combine']
             )
    tch_0 = st.text_input("Chose Filtering Method From Above:")
    if tch_0:
        if int(tch_0) == 1:
            corr_0 = (st.number_input('Enter thresold value C:'))
        elif int(tch_0) == 2:
            SNR_0 = (st.number_input('Enter thresold value S:'))
        elif int(tch_0) == 3:
            Lambda_0 = (st.number_input('Enter Lambda value for A:'))
            k_0 = (st.number_input('Enter k value for A:'))
        elif int(tch_0) == 4:
            corr_0 = (st.number_input('Enter thresold value C:'))
            SNR_0 = (st.number_input('Enter thresold value S:'))
        elif int(tch_0) == 5:
            ...
            Lambda_0 = (st.number_input('Enter Lambda value for A:'))
            k_0 = (st.number_input('Enter k value for A:'))
        elif int(tch_0) == 7 or int(tch_0) == 8:
            corr_0 = (st.number_input('Enter thresold value C:'))
            SNR_0 = (st.number_input('Enter thresold value S:'))
            Lambda_0 = (st.number_input('Enter Lambda value for A:'))
            k_0 = (st.number_input('Enter k value for A:'))
        ...
        sch_0 = st.text_input('Chose Replacement Method From Above:')
...
def code():
    ...
    def fk():
        ...
        constant_fk2d= int(var_1)  #0.75 
        multiplying_factor_3d = int(var_2)  # 0.5
        Shear_velocity = int(var_3)  # 2.6**3
